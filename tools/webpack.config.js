...
var webpackConfig = {
    entry: {
        "index": [path.join(configWebpack.path.example, "src/index/index")],
        "pindex": [path.join(configWebpack.path.example, "src/pindex/index")],
    },
    output: {
        ...
        rules: [
            ...
            },
            {
                ...
                use: [
                    ...
                    {
                        loader: 'css-loader?-autoprefixer&localIdentName=[name]-[local]-[hash:base64:5]'
                    },
                    {
                        loader: 'postcss-loader'
                    },
                    {
                        loader: 'less-loader?root=' + path.resolve('src')
                    } 
                ],
...
['index', 'pindex'].forEach((item) => {
    utils.addPlugins(webpackConfig, HtmlResWebpackPlugin, {
        mode: "html",
        filename: item + ".html",
        template: "example/src/" + item + ".html",
